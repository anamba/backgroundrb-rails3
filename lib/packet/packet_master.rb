  ...
  class Reactor
    ...
    def fork_and_load(worker_klass,worker_options = { })
      ...
      if(!(pid = fork))
        ...
        exec form_cmd_line(worker_read_end.fileno,worker_write_end.fileno,t_worker_name,option_dump_length), { worker_read_end.to_i => worker_read_end.to_i, worker_write_end.to_i => worker_write_end.to_i }
      end
      Process.detach(pid)
