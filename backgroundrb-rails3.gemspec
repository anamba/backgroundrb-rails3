...
# -*- encoding: utf-8 -*-
# stub: backgroundrb-rails3 1.1.7 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.authors = ["Matteo Latini", "Aaron Namba"]
  s.date = "2014-01-27"
  ...
  s.homepage = "http://github.com/anamba/backgroundrb-rails3"
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
